...
public class scope_and_decomp_4_1 {
}
...
public static void main(String[] args) {
    ...
    while (true) {
        ...
        int command = 0;
        printMenu(command); // вынесите печать меню в метод printMenu, здесь останется только его вызов
...
public static void printMenu(int command) {
